    ...
    def hk_gesture(self,results):
        with ScopedTiming("hk_gesture", self.debug_mode > 0):
            ...
            if 65535. not in angle_list:
                if (angle_list[0]>thr_angle_thumb) and all(a>thr_angle for a in angle_list[1:]):
                    gesture_str = "fist"
                elif all(a<thr_angle_s for a in angle_list):
                    gesture_str = "five"
                elif (angle_list[0]<thr_angle_s) and all(a>thr_angle for a in angle_list[2:]):
                    gesture_str = "gun"
                elif (angle_list[0]<thr_angle_s) and (angle_list[4]<thr_angle_s) and all(a>thr_angle for a in angle_list[2:4]):
                    gesture_str = "love"
                elif (angle_list[0]>5) and all(a<thr_angle_s for a in angle_list[1:]) and all(a>thr_angle for a in angle_list[2:]):
                    gesture_str = "one"
                elif (angle_list[0]<thr_angle_s) and (angle_list[4]<thr_angle_s) and all(a>thr_angle for a in angle_list[1:4]):
                    gesture_str = "six"
                elif (angle_list[0]>thr_angle_thumb) and all(a<thr_angle_s for a in angle_list[1:4]) and (angle_list[4]>thr_angle):
                    gesture_str = "three"
                elif (angle_list[0]<thr_angle_s) and all(a>thr_angle for a in angle_list[1:]):
                    gesture_str = "thumbUp"
                elif (angle_list[0]>thr_angle_thumb) and (angle_list[3]>thr_angle) and (angle_list[4]>thr_angle) and all(a<thr_angle_s for a in (angle_list[1], angle_list[2])):
                    gesture_str = "yeah"
            return gesture_str
