...
- Installed K230 CanMV firmware/build and matching API documentation, exact camera sensor and touch-panel variants, and the model/utility assets referenced under `/sdcard` by many examples.
