...
#define APP_FINISH_MARKER_MIN_CHANNELS         (3U)
#define APP_FINISH_POST_MARKER_MS              (2000U)
...
#define APP_BALL_HOLD_ENTER_ERROR_Q4            (80)
#define APP_BALL_HOLD_RELEASE_ERROR_Q4          (128)
...
#define APP_BALL_STEP_MAX_HZ                    (500U)
#define APP_BALL_STEP_HZ_PER_ERROR              (10U)
