...
SCRIPT_VERSION = "steel-ball-question5-fixed-center-uart-ack-v1"
QUESTION5_FIXED_TARGET = True
    ...
    try:
        ...
        while True:
            ...
            try:
                ...
                # Question 5 locks the displayed red line and UART target to O.
                # Touch support remains available when fixed-target mode is off.
                if (not QUESTION5_FIXED_TARGET) and (touch is None):
                ...
                while True:
                    ...
                    if (
                        ...
                        try:
                            ...
                            touch = None
                    if (not QUESTION5_FIXED_TARGET) and (touch is not None):
                        try:
                            points = touch.read(1)
                        except Exception as error:
